  ...
  return (
    <header className="bg-hero-bg text-white py-4">
      <div className="max-w-5xl mx-auto flex items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center gap-3 invisible" aria-hidden="true">
          <img src="/bkhs-logo-red.png" alt="" className="h-10" />
          <img src="/bkhs-text-white.png" alt="" className="h-8" />
        </div>

        {/* Mobile menu button (replaces nav and spacer on mobile) */}
